package com.tech.demo.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.tech.demo.service.EmailAlreadyUsedException ||
            ex instanceof com.tech.demo.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.tech.demo.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.tech.demo");
    }
}
